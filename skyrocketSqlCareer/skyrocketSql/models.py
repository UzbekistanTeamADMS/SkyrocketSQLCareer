...
class Allstarfull(models.Model):
    ...
    gameid = models.CharField(db_column='gameID', max_length=12, blank=True, null=True)  # Field name made lowercase.
    teamid = models.CharField(db_column='teamID', max_length=3, blank=True, null=True)  # Field name made lowercase.
    lgid = models.CharField(db_column='lgID', max_length=2, blank=True, null=True)  # Field name made lowercase.
...
class Appearances(models.Model):
    yearid = models.AutoField(db_column='yearID', primary_key=True)  # Field name made lowercase.
...
class Awardsmanagers(models.Model):
    ...
    tie = models.CharField(max_length=1, blank=True, null=True)
...
class Batting(models.Model):
    ...
    h2b = models.IntegerField(db_column='H2B', blank=True, null=True)  # Field name made lowercase.
    h3b = models.IntegerField(db_column='H3B', blank=True, null=True)  # Field name made lowercase.
...
class Halloffame(models.Model):
    ...
    inducted = models.CharField(max_length=1, blank=True, null=True)
    category = models.CharField(max_length=20, blank=True, null=True)
    needed_note = models.CharField(max_length=20, blank=True, null=True)
...
class Managers(models.Model):
    playerid = models.CharField(db_column='playerID', max_length=10, blank=True, null=True)  # Field name made lowercase.
    yearid = models.AutoField(db_column='yearID', primary_key=True)  # Field name made lowercase.
    teamid = models.CharField(db_column='teamID', max_length=3)  # Field name made lowercase.
    lgid = models.CharField(db_column='lgID', max_length=2, blank=True, null=True)  # Field name made lowercase.
    ...
    plyrmgr = models.CharField(db_column='plyrMgr', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class Master(models.Model):
    ...
    birthstate = models.CharField(db_column='birthState', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    deathcountry = models.CharField(db_column='deathCountry', max_length=50, blank=True, null=True)  # Field name made lowercase.
    deathstate = models.CharField(db_column='deathState', max_length=50, blank=True, null=True)  # Field name made lowercase.
    deathcity = models.CharField(db_column='deathCity', max_length=50, blank=True, null=True)  # Field name made lowercase.
    namefirst = models.CharField(db_column='nameFirst', max_length=50, blank=True, null=True)  # Field name made lowercase.
    namelast = models.CharField(db_column='nameLast', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    finalgame = models.CharField(db_column='finalGame', max_length=10, blank=True, null=True)  # Field name made lowercase.
    retroid = models.CharField(db_column='retroID', max_length=9, blank=True, null=True)  # Field name made lowercase.
    bbrefid = models.CharField(db_column='bbrefID', max_length=9, blank=True, null=True)  # Field name made lowercase.
...
class Schools(models.Model):
    ...
    schoolcity = models.CharField(db_column='schoolCity', max_length=55, blank=True, null=True)  # Field name made lowercase.
    schoolstate = models.CharField(db_column='schoolState', max_length=55, blank=True, null=True)  # Field name made lowercase.
    schoolnick = models.CharField(db_column='schoolNick', max_length=55, blank=True, null=True)  # Field name made lowercase.
...
class Seriespost(models.Model):
    ...
    teamidwinner = models.CharField(db_column='teamIDwinner', max_length=3, blank=True, null=True)  # Field name made lowercase.
    lgidwinner = models.CharField(db_column='lgIDwinner', max_length=2, blank=True, null=True)  # Field name made lowercase.
    teamidloser = models.CharField(db_column='teamIDloser', max_length=3, blank=True, null=True)  # Field name made lowercase.
    lgidloser = models.CharField(db_column='lgIDloser', max_length=2, blank=True, null=True)  # Field name made lowercase.
...
class Teams(models.Model):
    ...
    lgid = models.CharField(db_column='lgID', max_length=2)  # Field name made lowercase.
    teamid = models.CharField(db_column='teamID', max_length=3)  # Field name made lowercase.
    franchid = models.CharField(db_column='franchID', max_length=3, blank=True, null=True)  # Field name made lowercase.
    divid = models.CharField(db_column='divID', max_length=1, blank=True, null=True)  # Field name made lowercase.
    ...
    w = models.IntegerField(db_column='W', blank=True, null=True)  # Field name made lowercase.
    l = models.IntegerField(db_column='L', blank=True, null=True)  # Field name made lowercase.
    divwin = models.CharField(db_column='DivWin', max_length=1, blank=True, null=True)  # Field name made lowercase.
    wcwin = models.CharField(db_column='WCWin', max_length=1, blank=True, null=True)  # Field name made lowercase.
    lgwin = models.CharField(db_column='LgWin', max_length=1, blank=True, null=True)  # Field name made lowercase.
    wswin = models.CharField(db_column='WSWin', max_length=1, blank=True, null=True)  # Field name made lowercase.
    r = models.IntegerField(db_column='R', blank=True, null=True)  # Field name made lowercase.
    ab = models.IntegerField(db_column='AB', blank=True, null=True)  # Field name made lowercase.
    h = models.IntegerField(db_column='H', blank=True, null=True)  # Field name made lowercase.
    h2b = models.IntegerField(db_column='H2B', blank=True, null=True)  # Field name made lowercase.
    ...
    teamidbr = models.CharField(db_column='teamIDBR', max_length=3, blank=True, null=True)  # Field name made lowercase.
    teamidlahman45 = models.CharField(db_column='teamIDlahman45', max_length=3, blank=True, null=True)  # Field name made lowercase.
    teamidretro = models.CharField(db_column='teamIDretro', max_length=3, blank=True, null=True)  # Field name made lowercase.
...
class Teamsfranchises(models.Model):
    franchid = models.CharField(db_column='franchID', max_length=3)  # Field name made lowercase.
    franchname = models.CharField(db_column='franchName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    active = models.CharField(max_length=2, blank=True, null=True)
    naassoc = models.CharField(db_column='NAassoc', max_length=3, blank=True, null=True)  # Field name made lowercase.
